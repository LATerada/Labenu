...
function App() {
  ...
  //   try{
  //     const response = await axios.get(`https://us-central1-labenu-apis.cloudfunctions.net/labenusers/users/search?name=${nome}&email=${email}`,
  //       {
  //         headers: {
  //           Authorization: "larissa-terada-conway"
  //         },
            ...
            <ContainerBarra>
              <div>
                ...
                <input
                  ...
                  placeholder="Email"
                />
                <button value={pesquisa} type="submit" onClick={enviarDados}>
                  Pesquisar
                </button>
              </div>
              {pageFlow === 3 ? (
